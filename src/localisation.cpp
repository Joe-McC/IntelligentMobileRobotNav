...
BUGS:
-------------------------------------------------------------------------------------
1.) SCALING OF PARTICLES IS WRONG, THEY SEEM TO BE DOTTED OUTSIDE OF THE MAP  -  DONE
2.) TOP SECTION OF MAP IS CUT OFF - DONE
3.) DO WE NEED TO FIND 'ESTIMATED POSITION LIKE FOR 1D-ROBOT - DONE
4.) FIND PROPER ODOMETRY - DONE ; ALTHOUGH CALCS SEEM OFF, dY IS ALWAYS 0 ABD dX IS WAY TO BIG
5.) dX AND dY TRANSLATION AND ROTATION, SEE WEEK 10 DISCUSSION BOARD
-------------------------------------------------------------------------------------
**/
